...
function () {
  ...
  _createClass(Difference, [{
    ...
    value: function handleButtonClick(button, items, counter) {
    ...
    value: function bindTriggers() {
      this.handleButtonClick(this.oldOfficer.querySelector('.plus'), this.oldItems, this.oldCounter);
      this.handleButtonClick(this.newOfficer.querySelector('.plus'), this.newItems, this.newCounter); // this.oldOfficer.querySelector('.plus').addEventListener('click', () => {
      //     if (this.oldCounter !== this.oldItems.length - 2) {
      //         this.oldItems[this.oldCounter].style.display = 'flex';
      //         this.oldItems[this.oldCounter].classList.add(
      //             'animated',
      //             'fadeIn'
      //         );
      //         this.oldCounter++;
      ...
      //         this.newItems[this.newCounter].classList.add(
      //             'animated',
      //             'fadeIn'
      //         );
      //         this.newCounter++;
